/* Project2_Jones_nhj0004.cpp
* AUTHOR: Noah Jones
* References: 
* How to Compile. using the command 'g++ Project2_Jones_nhj0004 -o "hw2"' 
...
//VARIABLES
//Constant for Aaron's accuracy 
const int aaronAcc = 33; 
//Constant for Bob's accuracy 
const int bobAcc = 50;
//Constant for Charlie's accuracy 
const int charlieAcc = 100;
//Int to keep track of total number of runs for simulation
//Set to 10,000
const int TOTAL_RUNS = 10000;
//set all players to begin alive 
//bool value changes to false upon player's death 
bool aaronAlive = true;
bool bobAlive = true;
bool charlieAlive = true;
//keep tracks of amount of wins for each player
//initialized to zero wins to begin
int aaronWins1 = 0;
int aaronWins2 = 0;
int bobWins = 0;
int charlieWins = 0;
...
cout << "*** Welcome to Noah's Duel Simulator ***\n";
srand(time(0));
...
while (at_least_two_alive(aaronAlive, bobAlive, charlieAlive)) {
   //while at least two players are alive...
   //each player has a shot at the other two
   if (aaronAlive) {
...
TOTAL_RUNS * 100 << "%\n"
 << endl;
 //check which of Aaron's strategies is better
